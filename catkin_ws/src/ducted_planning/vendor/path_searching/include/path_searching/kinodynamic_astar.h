...
class RefreshableOpenSet : public std::priority_queue<PathNodePtr, std::vector<PathNodePtr>, NodeComparator> {
 public: void refresh() { std::make_heap(this->c.begin(),this->c.end(),this->comp); }
};
